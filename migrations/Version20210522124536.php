 ...
 */
final class Version20210522124536 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sub_order ADD comment LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sub_order DROP comment');
        $this->addSql('ALTER TABLE `table` CHANGE title title JSON NOT NULL');
    }
}
