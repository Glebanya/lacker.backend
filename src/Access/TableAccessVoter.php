...
class TableAccessVoter extends Voter
{
	...
	protected function canUpdate($subject, TokenInterface $token): bool
	{
		return
			...
			(in_array($user->getRole(),[Staff::ROLE_ADMINISTRATOR, Staff::ROLE_MANAGER]) or $user->isEqualTo($subject))
			;
	}
	...
	{
		return $subject instanceof Table;
	}
}