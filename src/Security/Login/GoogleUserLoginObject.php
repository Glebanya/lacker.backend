...
class GoogleUserLoginObject implements InterfaceLoginObject
{
	...
	public function __construct(private Google_Client $googleApiObject, private EntityManagerInterface $manager,
	...
	{
		$this->manager->persist(($user = new User())->setEmail($this->data['email'])->setUsername($this->data['name'])
